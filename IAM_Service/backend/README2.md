...
├── infrastructure/      # Implémentations techniques (repositories, adapters)
│   ├── persistence/
│   ├── messaging/
│   └── keycloak/
└── interfaces/          # Points d'entrée (REST controllers, event listeners)
```
...
- **Interfaces Layer**: APIs REST et consumers d'événements
